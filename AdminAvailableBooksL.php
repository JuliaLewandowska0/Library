...
<div class="page">
	...
	<div class="right">
		<form class="searchBar-AllBooksDisplay" action="AdminSearchResultL.php" method="POST">
		...
		<div class="product-wrapper" id="result">
			<?php //Podstawowe wyświetlanie wszystkich lektur, po filtrowaniu lub sortowaniu zmienia się zapytanie SQL
				...
				{
				?>
					<div class="product" onclick="details_connection_Admin_L(<?php echo $ksiazka['id_ksiazki'] ?>)">
						<div class="left2">
...
<script>
	$(document).ready(function() //Funkcja nasłuchująca zmian w filtrach poprzez zaznaczenie i przesyłająca wyniki do pliku modyfikującego zapytanie SQL
	{
		$(".product_check").click(function()
		{
			...
			$.ajax(
			{
				url:'includes/filter_sorting_Admin_L.php',
				method: 'POST',
				data:{action:action,nazwa_statusu:nazwa_statusu,rok_wydania_ksiazkiDESC:rok_wydania_ksiazkiDESC,
