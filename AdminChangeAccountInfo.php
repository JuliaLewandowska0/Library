...
<div class="main-content-ver1">
	<div class="main-block-RegisterLoginChange" id="main-block-ChangeInfo">
        ...
        <form class="registerForm" action="includes/change_acc_info_admin.php" method="post">
            ...
            <div class="submitButton-form" id="cancelButton2-form" onclick="location.href='AdminMyAccount.php';">Anuluj</div>
        </form>
        <?php
