...
<div class="page">
	...
	<div class="right">
		<form class="searchBar-AllBooksDisplay" action="SearchResultL.php" method="POST">
			<input id="searchField-AllBooksDisplay" type="text" name="searchField" placeholder="Wyszukaj tytuł lektury lub autora">
		...
		<div class="product-wrapper" id="result">
			<?php //Podstawowe wyświetlanie wszystkich książek, po filtrowaniu lub sortowaniu zmienia się zapytanie SQL
				...
				{
				?>
					<div class="product" onclick="details_connection_NoLogin_L(<?php echo $ksiazka['id_ksiazki'] ?>)">
						<div class="left2">
...
<script>
	$(document).ready(function() //Funkcja nasłuchująca zmian w filtrach poprzez zaznaczenie i przesyłająca wyniki do pliku modyfikującego zapytanie SQL
	{
		$(".product_check").click(function()
		{
			...
			$.ajax(
			{
				url:'includes/filter_sorting_L.php',
				method: 'POST',
