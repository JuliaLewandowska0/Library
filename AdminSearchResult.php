    ...
    <div class="left">
        ...
        <?php
            if(isset($_POST['submitSearchField']))
            {
                ...
                {
                    $ksiazki = getSearchResultLong($search);
					$query = getSearchResultLongQuery($search);
					$_SESSION["search_query"] = $query;
                }
                else
                {
                    $ksiazki = getSearchResultShort($search);
					$query = getSearchResultShortQuery($search);
					$_SESSION["search_query"] = $query;
                }
                ...
                <?php
                    ...
                    {
                    ?>
                        <div class="product" onclick="details_connection_Admin(<?php echo $ksiazka['id_ksiazki'] ?>)">
                            <div class="left2">
                    ...
                    <div id="returnButton_style5" onclick="location.href='AdminAllBooksDisplay.php';">Wróć do przeglądania</div>
                <?php
                }
...
<script>
	$(document).ready(function() //Funkcja nasłuchująca zmian w filtrach poprzez zaznaczenie i przesyłająca wyniki do pliku modyfikującego zapytanie SQL
	{
		$(".product_check").click(function()
		{
			...
			$.ajax(
			{
				url:'includes/filter_sorting_Admin_Search.php',
				method: 'POST',
