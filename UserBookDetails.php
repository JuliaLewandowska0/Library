<?php require 'includes/config_session.php'; ?>
<?php require 'includes/getUserInfo_contr.php'; ?>
<?php

if(isset($_POST['id_ksiazki'])) { //Przypisanie funkcji wyszukujących konkretne informacje do zmiennych
    $idb = $_POST['id_ksiazki'];
	$_SESSION['idKsiazki'] = $idb;
...
<div class="main-content-ver3">
	...
	<div class="returnButton_style3" onclick="location.href='UserAllBooksDisplay.php';">Wróć do przeglądania</div>
	<div class="returnButton_style3" id="add_to_favorite_rent-BookDetails" onclick="location.href='includes/add_to_favourite.php';">★Dodaj do ulubionych★</div>
</div>
