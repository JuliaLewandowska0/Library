...
<div class="page">
	...
	<div class="right">
		<form class="searchBar-AllBooksDisplay" action="SearchResult.php" method="POST">
			<input id="searchField-AllBooksDisplay" type="text" name="searchField" placeholder="Wyszukaj tytuł książki, wydawnictwo lub autora">
		...
		<div class="product-wrapper" id="result">
			<?php //Podstawowe wyświetlanie wszystkich książek, po filtrowaniu lub sortowaniu zmienia się zapytanie SQL
				...
				{
				?>
					<div class="product" onclick="details_connection_NoLogin(<?php echo $ksiazka['id_ksiazki'] ?>)">
						<div class="left2">
...
<script>
	$(document).ready(function() //Funkcja nasłuchująca zmian w filtrach poprzez zaznaczenie i przesyłająca wyniki do pliku modyfikującego zapytanie SQL
	{
		$(".product_check").click(function()
		{
			...
			$.ajax(
			{
				url:'includes/filter_sorting.php',
				method: 'POST',
				data:{action:action,nazwa_gatunku:nazwa_gatunku,rok_wydania_ksiazkiDESC:rok_wydania_ksiazkiDESC,
