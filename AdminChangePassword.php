...
<div class="main-content-ver1">
	<div class="main-block-RegisterLoginChange">
		<form class="registerForm" action="includes/change_password_admin.php" method="post">
            ...
            <div class="submitButton-form" id="cancelButton-form" onclick="location.href='AdminMyAccount.php';">Anuluj</div>
        </form>
        <?php
