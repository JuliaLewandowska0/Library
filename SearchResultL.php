...
<div class="navbar">
	...
	<div class="navbarMain">
		...
		<div id="navbarButtons" onclick="location.href='';">Zaloguj się</div>
	</div>
</div>
    ...
    <div class="left">
        ...
        <?php
            if(isset($_POST['submitSearchField']))
            {
                ...
                <div id="returnButton_style5" onclick="location.href='AllBooksLDisplay.php';">Wróć do przeglądania</div>
                <?php
                }
...
<script>
	$(document).ready(function() //Funkcja nasłuchująca zmian w filtrach poprzez zaznaczenie i przesyłająca wyniki do pliku modyfikującego zapytanie SQL
	{
		$(".product_check").click(function()
		{
			...
			$.ajax(
			{
				url:'includes/filter_sorting_Search_L.php',
				method: 'POST',
